...
//* Add header-left-logo-right.css
add_action( 'wp_enqueue_scripts', 'an_header' );
function an_header() {
    wp_enqueue_style( 'an-header', CHILD_URL . '/header-left-logo-right.css', array(), PARENT_THEME_VERSION );
}
